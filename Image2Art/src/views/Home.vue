...
<template>
  <div id="home">
    ...
    <nav id="mainNav" class="navbar navbar-expand-lg navbar-light fixed-top py-4">
      <div class="container">
        <a href="#home" class="navbar-brand js-scroll-trigger" style="position: absolute;left: 6%;top: 5%">
          <span class="navbar-brand-inverted-pink">I</span><span class="navbar-brand-inverted-blue">m</span><span
            class="navbar-brand-inverted-green">a</span><span class="navbar-brand-inverted-yellow">g</span><span
            class="navbar-brand-inverted-pink">e</span>2<span class="navbar-brand-inverted-blue">A</span><span
            class="navbar-brand-inverted-green">r</span><span class="navbar-brand-inverted-yellow">t</span>
        </a>
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-12 text-center text-light" style="position:absolute;bottom:9%">
                <router-link to="/Cartoon" class="mt-5 btn btn-primary px-5 btn-xl js-scroll-trigger"
                  style="font-size: 2rem;background-color:#f06292;margin-right: 4%">
                  头像转换
                </router-link>
                <router-link to="/TransferStyle" class="mt-5 btn btn-primary px-5 btn-xl js-scroll-trigger"
                  style="font-size: 2rem;background-color:#3498DB;margin-right: 4% ">
                  风格融合
                </router-link>
                <router-link to="/Doodle" class="mt-5 btn btn-primary px-5 btn-xl js-scroll-trigger"
    ...
    <section id="about" class="page-section">
      <div class="container carousel-container text-center">
        <h2 class="mt-0">
          <span class="text-primary font-weight-bold">Image</span>2<span
            class="text-primary font-weight-bold">Art</span>官方网站
        </h2>
