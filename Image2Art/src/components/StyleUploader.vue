        ...
        <div class="row">
             <div class="left">
                 ...
                 <div class="row pre-scrollable">
                     <form> <input type="radio"  value="scream" v-model="picked" name="1"><img src="img/style/the_scream.jpg" for="the_scream.jpg" preview="0"  class="img-thumbnail" ><br/>
                         <input type="radio" value="wave" v-model="picked" name="1"><img src="img/style/wave.jpg" preview="0" class="img-thumbnail" ><br/>
                         <input type="radio"  value="wreck" v-model="picked" name="1"><img src="img/style/the_shipwreck_of_the_minotaur.jpg" preview="0" class="img-thumbnail" ><br/>
                         <input type="radio" value="udnie" v-model="picked" name="1"><img src="img/style/udnie.jpg" preview="0" class="img-thumbnail" ><br/>
                         <input type="radio"  value="rain_princess" v-model="picked" name="1"><img src="img/style/rain_princess.jpg" preview="0" class="img-thumbnail" ><br/>
                         <input type="radio"  value="la_muse" v-model="picked" name="1"><img src="img/style/la_muse.jpg" preview="0"  class="img-thumbnail" ><br/>
                     </form>
        ...
        async  getCropBlob() {
            ...
            await  cropper.getCropBlob(async data => {
                ...
                if (this.picked==""){
                    ...
                    this.step="upload";
                    try {
                    await axios.post("http://127.0.0.1:8000/myapp/styleimage/" , this.form_data, {
