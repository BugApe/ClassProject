    ...
    <div class="row">
      <div class="left">
        <div class="row pre-scrollable">
          <form>
            <input type="radio" value="Gogh.jpg" v-model="picked" name="1"><img src="img/doodle/Gogh.jpg"
              large="img/doodle/Gogh_sem.jpg" preview="0"
              preview-text="示意图中的色块代表原图对应位置的纹理（图片内容、绘画风格）。按照示意图给出的区域色块，采用相同的颜色绘制出涂鸦，然后上传图片，即可获得您自己的大作"
              class="img-thumbnail">
            <input type="radio" value="Renoir.jpg" v-model="picked" name="1"><img src="img/doodle/Renoir.jpg"
              large="img/doodle/Renoir_sem.jpg" preview="1"
              preview-text="示意图中的色块代表原图对应位置的纹理（图片内容、绘画风格）。按照示意图给出的区域色块，采用相同的颜色绘制出涂鸦，然后上传图片，即可获得您自己的大作"
              class="img-thumbnail">
            <input type="radio" value="Mia.jpg" v-model="picked" name="1"><img src="img/doodle/Mia.jpg"
              large="img/doodle/Mia_sem.jpg" preview="2"
              preview-text="示意图中的色块代表原图对应位置的纹理（图片内容、绘画风格）。按照示意图给出的区域色块，采用相同的颜色绘制出涂鸦，然后上传图片，即可获得您自己的大作"
              class="img-thumbnail">
            <input type="radio" value="Freddie.jpg" v-model="picked" name="1"> <img src="img/doodle/Freddie.jpg"
              large="img/doodle/Freddie_sem.jpg" preview="3"
              preview-text="示意图中的色块代表原图对应位置的纹理（图片内容、绘画风格）。按照示意图给出的区域色块，采用相同的颜色绘制出涂鸦，然后上传图片，即可获得您自己的大作"
              class="img-thumbnail">
            <input type="radio" value="Monet.jpg" v-model="picked" name="1"><img src="img/doodle/Monet.jpg"
              large="img/doodle/Monet_sem.jpg" preview="4"
              preview-text="示意图中的色块代表原图对应位置的纹理（图片内容、绘画风格）。按照示意图给出的区域色块，采用相同的颜色绘制出涂鸦，然后上传图片，即可获得您自己的大作"
              class="img-thumbnail">
            <input type="radio" value="Seth.jpg" v-model="picked" name="1"> <img src="img/doodle/Seth.jpg"
              large="img/doodle/Seth_sem.jpg" preview="5"
              preview-text="示意图中的色块代表原图对应位置的纹理（图片内容、绘画风格）。按照示意图给出的区域色块，采用相同的颜色绘制出涂鸦，然后上传图片，即可获得您自己的大作"
              class="img-thumbnail">
          </form>
      ...
      <div class="tab-content right">
        ...
        <div v-show="step === 'crop'" class="crop-container col-sm">
          <div class="crop-container-inner text-center">
            ...
            <button class="btn btn-primary btn-lg p-3 mb-4 text-uppercase" style="background-color: #657350"
            ...
            <div v-if="hasUploadError">
              ...
              <div class="my-3">
                ...
                <button class="btn btn-primary btn-lg p-3 text-uppercase" aria-pressed="true"
                  style="background-color: #657350" onclick="window.location.reload()">
                  重试
                </button>
              </div>
  ...
  async getCropBlob() {
    ...
    await cropper.getCropBlob(async (data) => {
      ...
      if (this.picked === "") {
        ...
        try {
          await axios
            .post("http://172.18.28.167:8087/myapp/image/", this.formData, {
