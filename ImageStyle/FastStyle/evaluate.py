...
def build_parser(input,style):
    parser = ArgumentParser()
    parser.add_argument('--checkpoint', type=str,
                        default='E:\ClassProject\ClassProject\ImageStyle\FastStyle/Fast_Style_Transfer_Models/'+style,
                        dest='checkpoint_dir',
                        help='dir or .ckpt file to load checkpoint from',
                        metavar='CHECKPOINT')

    parser.add_argument('--in-path', type=str, default='E:/ClassProject/ClassProject/ImageStyle/images/'+input ,
                        dest='in_path',help='dir or file to transform',
                        metavar='IN_PATH')

    help_out = 'destination (dir or file) of transformed file or files'
    parser.add_argument('--out-path', type=str, default='E:/ClassProject/ClassProject/ImageStyle/static/',
...
def main(input,style):
    parser = build_parser(input,style)
